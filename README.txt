...
3. Klasa LinkedMap, która rozszerza LinkedHashMap została wykorzystana do przechowywania obiektów w cache'u. Zawiera ona dodatkową metodę 
  umożliwiającą pobieranie obiektów za pomocą indexu.
